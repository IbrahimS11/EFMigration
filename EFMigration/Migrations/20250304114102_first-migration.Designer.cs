...
namespace EFMigration.Migrations
{
    ...
    [Migration("20250304114102_first-migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EFMigration.Entities.SectionSchedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFMigration.Entities.SectionSchedule", b =>
                {
                    b.HasOne("EFMigration.Entities.Schedule", null)
                        .WithMany("SectionSchedules")
                        .HasForeignKey("ScheduleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EFMigration.Entities.Section", null)
                        .WithMany("SectionSchedules")
                        .HasForeignKey("SectionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
